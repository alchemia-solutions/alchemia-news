...
em `.claude/` na raiz da empresa — **nunca neste diretório**. As contagens do harness passaram a
ser **13 sub-agentes / 20 skills**, e `harness/check_runtime_integrity.py` já valida esses números.
...
**Cuidado com contagem:** não cite 13/20 de memória em outro documento. Os números do harness mudam
quando um setor novo aparece — confira com `ls` ou rode o `check_runtime_integrity.py`.
